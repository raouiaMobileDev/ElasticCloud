...
public class StartPound {
	...
	public static boolean start() {
		...
		return runServer("sudo /etc/init.d/pound start");

	}

	public static boolean stop() {
		return runServer("sudo /etc/init.d/pound stop");

	}
	
	public static boolean restart() {
		return runServer("sudo /etc/init.d/pound restart");
