...
public class AnalyzeAgentRORI extends Agent {
	...
	protected void setup() {
		...
		try {
			...
			dfd.setName(new AID("AnalyzeAgentRORI", AID.ISLOCALNAME));
			...
			public void action() {
				...
				if (msgSendorAgent != null) 
	        	{
					...
					if(Nb_VMs==2)
					{
						...
						if(cpuUsage > CPUThdIN && tampon2!=0)
							tampon2=0;
						//******************************************************
